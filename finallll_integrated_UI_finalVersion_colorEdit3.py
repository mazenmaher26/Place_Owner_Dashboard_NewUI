...
# =========================
# CHART THEME — force white background regardless of Streamlit theme
# =========================
CHART_LAYOUT = dict(
    paper_bgcolor = "#FFFFFF",
    plot_bgcolor  = "#FFFFFF",
    font          = dict(color="#1D3143"),
)
